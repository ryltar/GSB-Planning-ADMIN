...
class EmployeeService:
   ...
   def getAllEmployee(self,token):
      url = "http://gsb-planning-api/admin/employees"
   ...
   def getOneEmployee(self,token, id):
      url = "http://gsb-planning-api/admin/employees/"+str(id)
      headers = {'authorization': token,
                  'Connection':'keep-alive'}
   ...
   def putOneEmployee(self, token, employee):
      url = "http://gsb-planning-api/admin/employees/"+str(employee.id)
   ...
   def deleteOneEmployee(self,token, key):
      url = "http://gsb-planning-api/admin/employees/"+str(key)
      headers = {'authorization': token}
