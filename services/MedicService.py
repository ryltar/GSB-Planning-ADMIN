...
class MedicService:
   ...
   def getAllMedic(self,token):
      url = "http://claudioppe.ddns.net/admin/medics"
   ...
   def getOneMedic(self,token, id):
      url = "http://claudioppe.ddns.net/admin/medics/"+str(id)
      headers = {'authorization': token,
                  'Connection':'keep-alive'}
   ...
   def putOneMedic(self, token, medic):
      url = "http://claudioppe.ddns.net/admin/medics/"+str(medic.id)
   ...
   def deleteOneMedic(self,token, key):
      url = "http://claudioppe.ddns.net/admin/medics/"+str(key)
      headers = {'authorization': token}
