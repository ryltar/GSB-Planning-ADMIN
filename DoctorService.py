...
class DoctorService:
   ...
   def getAllDoctor(self,token):
      url = "http://gsb-planning-api/admin/doctors"
   ...
   def getOneDoctor(self,token, id):
      url = "http://gsb-planning-api/admin/doctors/"+str(id)
      headers = {'authorization': token,
                  'Connection':'keep-alive'}
   ...
   def putOneDoctor(self, token, doctor):
      url = "http://gsb-planning-api/admin/doctors/"+str(doctor.id)
   ...
   def deleteOneDoctor(self,token, key):
      url = "http://gsb-planning-api/admin/doctors/"+str(key)
      headers = {'authorization': token}
