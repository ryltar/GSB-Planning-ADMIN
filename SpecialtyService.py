...
class SpecialtyService:
   ...
   def getAllSpecialty(self,token):
      url = "http://gsb-planning-api/admin/specialties"
   ...
   def getOneSpecialty(self,token, id):
      url = "http://gsb-planning-api/admin/specialties/"+str(id)
      headers = {'authorization': token,
                  'Connection':'keep-alive'}
   ...
   def putOneSpecialty(self, token, specialty):
      url = "http://gsb-planning-api/admin/specialties/"+str(specialty.id)
   ...
   def deleteOneSpecialty(self,token, key):
      url = "http://gsb-planning-api/admin/specialties/"+str(key)
      headers = {'authorization': token}
